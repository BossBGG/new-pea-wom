...
import { faHistory, faPrint, faEdit, faPlay, faTimes, faChevronDown, faPlus } from "@fortawesome/free-solid-svg-icons";
...
const WorkOrderDetailsWaiting = () => {
  ...
  const handleStartWorkConfirm = () => {
    ...
    router.push("/work_order/s332-solar-air-conditioner/workOrderDetailsStartWorking");
  };
  ...
  const handleEdit = () => {
    router.push("/work_order/s332-solar-air-conditioner");
  };
  ...
  const renderMobileActions = () => (
    <div className="flex flex-col space-y-3 mt-6 px-4">
      <Button
        className="pea-button h-[44px] w-full"
        onClick={handleStartWork}
      >
        เริ่มปฏิบัติงาน
      </Button>
