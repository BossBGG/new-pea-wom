        ...
        <div className="w-full md:w-1/3 px-3">
          <div className="w-full mb-3">
            <InputDateRange setData={(v) => handleDateChange('repeat_start_date',v)}
                            data={{
                              from: electricGenerate?.generatorStartDate ? new Date(electricGenerate.generatorStartDate) : undefined,
                              to: electricGenerate?.generatorEndDate ? new Date(electricGenerate.generatorEndDate) : undefined,
                            }}
