...
import {
  ...
  RequestServiceItem, ResolvedData, S301ServiceData, S318ServiceData, StepWorkOrderObj,
  Transformer,
  User,
  WorkOrderObj
} from "@/types";
...
import {
  ...
  mapTransformerSizeOptions, mapTransformerVoltageOptions, mapMeterEquipmentOptions,
...
const CreateOrUpdateWorkOrder = () => {
  ...
  const fetchWorkOrderDetail = async (
    ...
    getWorkOrderDetailById(workOrderId).then(async (res) => {
      if (res.status === 200) {
        ...
        if(requestCode === 's318') {
          ...
          let materialEquipment = await mapMeterEquipmentOptions(serviceSpecS318.equipments, resMeterEquipmentOptions || [], requestCode)
