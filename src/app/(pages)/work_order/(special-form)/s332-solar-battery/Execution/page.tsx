...
const ElectricalRepairOrderS332SolarBattery = () => {
  ...
  useEffect(() => {
    setBreadcrumb(
      <WorkOrderBreadcrumb
        title={
          "สร้างใบสั่งงาน ขอตรวจสอบและบำรุงรักษาระบบไฟฟ้า แบบครบวงจร (Package)"
        }
        path={"s332-solar-battery-execution"}
      />
    );
  }, [setBreadcrumb]);
  ...
  const handleEndWorkConfirm = () => {
    ...
    router.push("/work_order/s332-solar-battery/workOrderDetailsCompleted");
  };
