...
interface ListDataContentProps {
  realData: TransFormerS315[];
  pageData: TransFormerS315[];
  onUpdateData: (data: TransFormerS315[]) => void;
...
const ListDataContent = ({
  ...
  const handleUpdateData = (
    ...
    const newData = realData.map((item: TransFormerS315, idx) => {
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex space-x-2 ml-4">
                  ...
                  <button
                    ...
                    onClick={() => deleteData(item.id as number || 0, index)}
                  >
                    <FontAwesomeIcon
                      icon={faTrashCan}
                      size={"sm"}
