...
const ElectricalList = ({
  ...
  const [requestService, setRequestService] = useState<RequestServiceItem[]>([])
  ...
  useEffect(() => {
    ...
    setRequestService(requestService?.items as RequestServiceItem[] || [])
  ...
  const handleUpdateData = (items: RequestServiceItem[]) => {
    let newData = data;
    newData = {
      ...newData,
      requestServiceDetail: {
