...
import {Customer, Electrical, RequestServiceItem, WorkerObj, WorkOrderObj} from "@/types";
...
const ElectricalRepairOrderS301 = () => {
  ...
  const handleEndWorkConfirm = () => {
    ...
    router.push("/work_order/s301/workOrderDetailsCompleted");
  };
  ...
  // Custom Action Buttons for Execution
