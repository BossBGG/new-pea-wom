...
const ModalEquipments = ({
  ...
  const [equipmentList] = useState<MaterialEquipmentObj[]>([
    {name: 'ฉนวนครอบสายไฟฟ้า A', quantity: 1, id: 1, isEdited: false} as MaterialEquipmentObj,
    {name: 'ฉนวนครอบสายไฟฟ้า B', quantity: 1, id: 2, isEdited: false} as MaterialEquipmentObj,
    {name: 'ฉนวนครอบสายไฟฟ้า C', quantity: 1, id: 3, isEdited: false} as MaterialEquipmentObj,
  ]);
