...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    const response = await getDashboardData('2025', viewMode)
  ...
  return (
    <div>
      ...
      <div className="flex my-4 flex-wrap items-stretch">
        ...
        <StatCard backgroundColor="#FFF4E4" iconColor="#E86339" value={data.summary?.inProgress || 0} label="ระหว่างการดำเนินงาน" unit="/ งาน" icon={faClock}/>
