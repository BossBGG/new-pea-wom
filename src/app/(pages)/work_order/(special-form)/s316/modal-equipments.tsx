...
const ModalEquipments = ({
  ...
  const [equipmentList] = useState<MaterialEquipmentObj[]>([
    {name: 'หม้อแปลง A', size: 'ขนาด A',quantity: 1, id: 1, isEdited: false} as MaterialEquipmentObj,
    {name: 'หม้อแปลง B', size: 'ขนาด B', quantity: 1, id: 2, isEdited: false} as MaterialEquipmentObj,
    {name: 'หม้อแปลง C', size: 'ขนาด C',quantity: 1, id: 3, isEdited: false} as MaterialEquipmentObj,
  ]);
