              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <div className="font-medium text-sm mb-2 text-gray-800">
                    {index + 1}. {brandOptions.find((brand) => brand.value == item.title)?.label || item.title}
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row">
                      <div className="text-sm text-gray-600 mb-1 md:mb-0 me-2">
                        ...
                        <span className="font-medium text-sm text-black">
                          {phaseOptions.find((phase) => phase.value == item.phase)?.label || item.phase}
                        </span>
                      </div>
                      ...
                      <div className="text-sm text-gray-600 mb-1 md:mb-0 me-2">
                        <span>ประเภท : </span>
                        <span className="font-medium text-sm text-black">
                          {typeOptions.find((type) => type.value == item.type)?.label || item.type}
                        </span>
                      </div>
                      ...
                      <div className="text-sm text-gray-600 mb-1 md:mb-0 me-2">
                        <span>ขนาด : </span>
                        <span className="font-medium text-sm text-black">
                          {sizeOptions.find((size) => size.value == item.size)?.label || item.size}
                        </span>
                      </div>
                      ...
                      <div className="text-sm text-gray-600">
                        <span>แรงดัน : </span>
                        <span className="font-medium text-sm text-black">
                          {voltageOptions.find((volt) => volt.value == item.voltage)?.label || item.voltage}
                        </span>
                      </div>
                    </div>
