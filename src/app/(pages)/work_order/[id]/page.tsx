...
import {MaterialEquipmentObj, Options, RequestServiceItem, ResolvedData, WorkOrderObj} from "@/types";
  ...
  return (
    <div>
      ...
      <div className="w-full">
        {/* Work Order Detail */}
        <WorkOrderInfo data={data} status={renderStatusWorkOrder(data.workOrderStatusCode)} />
