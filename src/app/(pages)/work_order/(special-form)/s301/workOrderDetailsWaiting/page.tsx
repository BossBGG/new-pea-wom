...
import { faHistory, faPrint, faEdit, faPlay, faTimes } from "@fortawesome/free-solid-svg-icons";
...
const WorkOrderDetailsWaiting = () => {
  ...
  const handleStartWorkConfirm = () => {
    ...
    router.push("/work_order/s301/workOrderDetailsStartWorking");
  };
  ...
  const renderMobileActions = () => (
    <div className="flex flex-col space-y-3 mt-6 px-4">
      <div className="flex flex-col space-x-3 ">
        <Button
          className="pea-button h-[44px] flex-1 mb-2"
          onClick={handleStartWork}
        >
          เริ่มปฏิบัติงาน
        </Button>
        ...
        <Button
          className="cancel-button h-[44px] flex-1 mb-2"
          variant="outline"
          onClick={handleCancel}
        >
          ยกเลิกใบสั่งงาน
        ...
        <Button
          className="pea-button-outline h-[44px] flex-1 mb-2"
          variant="outline"
          onClick={handleEdit}
        >
          แก้ไข
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0">
            <div className="flex flex-row justify-between">
              ...
              <Button
                className="bg-[#E1D2FF] rounded-full justify-center items-center h-[44px] px-6"
                variant="outline"
