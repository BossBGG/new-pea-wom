...
interface ListDataContentProps {
  realData: S315TransformerServiceData[];
  pageData: S315TransformerServiceData[];
  onUpdateData: (data: S315TransformerServiceData[]) => void;
...
const ListDataContent = ({
  ...
  const handleUpdateData = (
    ...
    const newData = realData.map((item: S315TransformerServiceData, idx) => {
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <div className="font-medium text-sm mb-2 text-gray-800">
                    {index + 1}. {item.transformerCapacity}
                  </div>
