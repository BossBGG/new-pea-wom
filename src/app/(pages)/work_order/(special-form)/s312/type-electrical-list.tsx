...
const TypeElectricalList = ({
  ...
  useEffect(() => {
    if (screenSize !== 'desktop') {
      const newElectricalEquipments: ElectricalEquipment[] = electricalEquipments.map((item) => {
  ...
  const handleUpdateData = (data: ElectricalEquipment[]) => {
    ...
    const handleAddEquipment = (equipment: MaterialEquipmentObj) => {
      ...
      const updatedElectricalEquipments = [...electricalEquipments, newElectricalEquipment];
