...
import { faHistory, faPrint, faEdit, faSave, faTimes, faChevronDown, faPlus } from "@fortawesome/free-solid-svg-icons";
...
import TypeElectricalList from "../type-electrical-list";
...
const WorkOrderDetailsStartWorking = () => {
  ...
  const handleEndWorkConfirm = () => {
    ...
    router.push("/work_order/s311/Execution");
  };
